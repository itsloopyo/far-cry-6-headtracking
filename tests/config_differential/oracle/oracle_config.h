...
// The reader of the newest published build, v0.1.0 (faf077b), for the differential
// test only. Copied from src/config.h at that tag. The only edits: the namespace is
// FarCry6HeadTracking::oracle, and the ADS helpers come from oracle_ads.h.

#include "oracle_ads.h"
